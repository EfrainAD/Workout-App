...
import { ButtonItem, SearchItem, TitleText, DescriptionText, CardTitle, SectionLeft, SectionRight, ButtonGroup, ButtonRow, ButtonCardStyle } from './help.screen.styles'
            ...
            <ScrollView>
               ...
               <ButtonGroup>
                  <ButtonItem>
                     ...
                     <DescriptionText>Information on resolving account issues</DescriptionText>
                  </ButtonItem>
                  <ButtonItem>
                     <TitleText>SetRep 101</TitleText>
                     <DescriptionText>Basics to help you get started</DescriptionText>
                  </ButtonItem>
                  <ButtonItem>
                     <TitleText>Rules & Report</TitleText>
                     <DescriptionText>Information on Reddit policies, reporting, copyright, and more</DescriptionText>
                  </ButtonItem>
                  <ButtonItem>
                     <TitleText>Privacy & Security</TitleText>
                     <DescriptionText>All about your account and data</DescriptionText>
                  </ButtonItem>
                  <ButtonItem>
                     <TitleText>Q & A</TitleText>
                     <DescriptionText>Frequently asked questions</DescriptionText>
                  </ButtonItem>
               </ButtonGroup>
